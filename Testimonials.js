...
export default function Testimonials(props) {
    ...
    function surpriseHandler(){
        ...
        // Now you can use randomValue for something meaningful.
...
<div>
    ...
    className='bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer px-12 py-3 mt-6 rounded-md font-bold text-lg text-white'>
        Surprise ME
    </button>
</div>
